...
Cooking.AvailableInstances = {
    game.Workspace.PlaceModels:FindFirstChild("Cooking")
}

function Cooking:StopSink(chr)
...
function Cooking:Start()
    self:Enable()
end

function Cooking.new(baseTbl)
    local newInst = baseTbl.MachineFuncs.GetAvailableInst(Cooking.AvailableInstances)
